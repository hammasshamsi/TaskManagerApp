...
export default function Dashboard({ auth,activeTasks, totalPendingTasks,myPendingTasks, myProgressTasks, totalProgressTasks, myCompletedTasks, totalCompletedTasks  }) {
    return (
        <AuthenticatedLayout
            user={auth.user}
