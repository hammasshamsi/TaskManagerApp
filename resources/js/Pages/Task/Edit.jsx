...
export default function Create({auth,task,projects,users}){
    ...
    return(
        ...
        >
            ...
            <Head title="Tasks" />     {/*This will be the title of the page*/}
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        ...
                        >
                            ...
                            {/*This code is for retrieve last image on task */}
                            {task.image_path &&

                                <div className="mb-4">

                                    <img src={task.image_path} alt={task.name} className="w-1/4 h-1/4" />
                            ...
                            <div className="mt-4 text-right">
                                ...
                                <button className="bg-emerald-600 py-1 px-3 text-white rounded shadow transition-all hover:bg-emerald-600">
                                    Submit
                                </button>
